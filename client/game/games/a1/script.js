const questions = [
    {
        question: "What is the first letter in alphabet ?", 
        answers: [
    ...
    {
        question: "What is Melingo ?", 
        answers: [
            {text: "English Courses" , correct: false},
            {text: "A Flashcard" , correct: false},
            {text: "A Friend" , correct: true},
            {text: "English Website" , correct: false},
        ]
    },
